...
// (Orange Money / MTN Mobile Money) et, seulement alors, marquer une commande
// payée (marketplace_orders.is_paid). La cliente ne peut jamais écrire ces
// champs (RLS + triggers P0-1).
//
...
//   4) Muter is_paid via service_role uniquement.
//
...
Deno.serve(async (req) => {
  ...
  if (!reference || !status || amount == null || target_type !== "order") {
